...
public class NOAText_jsl implements ITextPlugin {
	public static final String MIMETYPE_OO2 = "application/vnd.oasis.opendocument.text";
	public static LinkedList<NOAText_jsl> noas = new LinkedList<NOAText_jsl>();
	OfficePanel panel;
	ITextDocument doc;
	ICallback textHandler;
	File myFile;
	private final Log log = Log.get("NOAText_jsl");
	...
	public NOAText_jsl(){
		System.out.println("NOAText_jsl: NOAText_jsl: noa loaded");
		System.out.println("NOAText_jsl: NOAText_jsl: computing defaultbase...");
		File base = new File(Hub.getBasePath());
		File fDef = new File(base.getParentFile().getParent() + "/ooo");
		System.out.println("NOAText_jsl: NOAText_jsl: Hub.getBasePath():"+Hub.getBasePath());
		System.out.println("NOAText_jsl: NOAText_jsl: base.getParentFile().getParent() + \"/ooo\":"+base.getParentFile().getParent() + "/ooo");
		String defaultbase;
		if (fDef.exists()) {
		...
		System.out.println("NOAText_jsl: NOAText_jsl: computed defaultbase=openoffice.path.name:"+defaultbase);
	...
	private void createMe(){
		...
		if (office == null) {
			System.out.println("NOAText_jsl: Please note: createMe: office==null");
			office = EditorCorePlugin.getDefault().getManagedLocalOfficeApplication();
		}
		
		if (office == null)	System.out.println("NOAText_jsl: createMe: WARNING: still, office==null");
		else 				System.out.println("NOAText_jsl: createMe: office="+office.toString());
		
		if (panel == null)	System.out.println("NOAText_jsl: createMe: WARNING: panel==null");
		else 				System.out.println("NOAText_jsl: createMe: panel="+panel.toString());

		doc = (ITextDocument) panel.getDocument();
		
		if (doc == null)	System.out.println("NOAText_jsl: createMe: WARNING: doc==null");
		else 				System.out.println("NOAText_jsl: createMe: doc="+doc.toString());
		...
		System.out.println("NOAText_jsl: createMe ends");
	}
	...
	private void removeMe(){
		System.out.println("NOAText_jsl: removeMe");
		try {
			System.out.println("NOAText_jsl: removeMe: trying 1...");
				if (textHandler != null) {
				System.out.println("NOAText_jsl: removeMe: textHandler.save()...");
				textHandler.save();
				System.out.println("NOAText_jsl: removeMe: noas.remove(this)...");;
				noas.remove(this);
				if (doc != null) {
					doc.setModified(false);
					System.out.println("NOAText_jsl: removeMe: doc.close()...");
					doc.close();
				}
			}
		} catch (Exception ex) {
			System.out.println("NOAText_jsl: removeMe: WARNING: caught Exception");
			ExHandler.handle(ex);
		}
		if (noas.isEmpty()) {
			System.out.println("NOAText_jsl: removeMe: noas.isEmpty()");
			try {
				System.out.println("NOAText_jsl: removeMe: trying office.deactivate()...");
				office.deactivate();
	...
	public boolean clear(){
		System.out.println("NOAText_jsl: clear");
		if (textHandler != null) {
			try {
				textHandler.save();
				doc.setModified(false);
	...
	public Composite createContainer(final Composite parent, final ICallback handler){
		System.out.println("NOAText_jsl: createContainer");
		new Frame();
	...
	public boolean createEmptyDocument(){
		System.out.println("NOAText_jsl: createEmptyDocument");
		try {
			clean();
	...
	public boolean loadFromByteArray(final byte[] bs, final boolean asTemplate){
		System.out.println("NOAText_jsl: loadFromByteArray");
		if (bs == null) {
	...
	public boolean loadFromStream(final InputStream is, final boolean asTemplate){
		System.out.println("NOAText_jsl: loadFromStream");
		try {
			clean();
			doc =
	...
	public byte[] storeToByteArray(){
		System.out.println("NOAText_jsl: storeToByteArray");
		if (doc == null) {
			return null;
		}
		try {
	 ...
	 */
	public void dispose(){
		System.out.println("NOAText_jsl: dispose");
		if (doc != null) {
			doc.close();
			doc = null;
		}
	...
	public boolean findOrReplace(final String pattern, final ReplaceCallback cb){
		System.out.println("NOAText_jsl: findOrReplace");
	...
	public boolean isInteger(String input)	{  
		System.out.println("NOAText_jsl: isInteger");
		try	{  
	...
	*/
	static public int getFormComponentType(XPropertySet xComponent)	{
		System.out.println("NOAText_jsl: getFormComponentType");
	...
	public PageFormat getFormat(){
		System.out.println("NOAText_jsl: getFormat");
		return ITextPlugin.PageFormat.USER;
	}
	
	public String getMimeType(){
		System.out.println("NOAText_jsl: getMimeType");
		return MIMETYPE_OO2;
	}
	...
	public boolean insertTable(final String place, final int properties, final String[][] contents,
		...
		System.out.println("NOAText_jsl: insertTable");
		int offset = 0;
	...
	public Object insertText(final String marke, final String text, final int adjust){
		System.out.println("NOAText_jsl: insertText, return a cursor");
	...
	public Object insertText(final Object pos, final String text, final int adjust){
		System.out.println("NOAText_jsl: insertText at pos returned");
	...
	public Object insertTextAt(final int x, final int y, final int w, final int h,
		...
		System.out.println("NOAText_jsl: insertTextAt");
		try {
	...
	public boolean print(final String toPrinter, final String toTray,
		...
		System.out.println("NOAText_jsl: print");
		try {
	...
	public void setFocus(){
		System.out.println("NOAText_jsl: setFocus stub");
		// TODO Auto-generated method stub
	
	}
	
	public void setFormat(final PageFormat f){
		System.out.println("NOAText_jsl: PageFormat stub");
		// TODO Auto-generated method stub
	
	}
	
	public void setSaveOnFocusLost(final boolean bSave){
		System.out.println("NOAText_jsl: setSaveOnFocusLost stub");
		// TODO Auto-generated method stub
	
	}
	
	public void showMenu(final boolean b){
		System.out.println("NOAText_jsl: showMenu stub");
		// TODO Auto-generated method stub
	
	}
	
	public void showToolbar(final boolean b){
		System.out.println("NOAText_jsl: showToolbar stub");
		// TODO Auto-generated method stub
	...
	public void setInitializationData(final IConfigurationElement config,
		...
		System.out.println("NOAText_jsl: setInitializationData stub");
		// TODO Auto-generated method stub
	 ...
	 */
	private void clean(){
		System.out.println("NOAText_jsl: clean");
		try {
			if (doc != null) {
				doc.getPersistenceService().store(myFile.getAbsolutePath());
				// doc.close();
	...
	public boolean setFont(final String name, final int style, final float size){
		System.out.println("NOAText_jsl: setFont");
		font = name;
		hi = size;
		stil = style;
		return true;
	...
	public boolean setStyle(final int style){
		System.out.println("NOAText_jsl: setStyle");
		stil = style;
		return true;
	}
	...
	private com.sun.star.beans.XPropertySet setFormat(final XTextCursor xtc)
		...
		System.out.println("NOAText_jsl: setFormat");
	...
	class closeListener implements ICloseListener {
		...
		public closeListener(final IOfficeApplication officeAplication){
			System.out.println("NOAText_jsl: closeListener: closeListener");
		...
		public void queryClosing(final ICloseEvent closeEvent, final boolean getsOwnership){
			System.out.println("NOAText_jsl: closeListener: queryClosing nop");
		...
		public void notifyClosing(final ICloseEvent closeEvent){
			System.out.println("NOAText_jsl: closeListener: notifyClosing");
			try {
				removeMe();
		...
		public void disposing(final IEvent event){
			System.out.println("NOAText_jsl: closeListener: disposing nop");
			// nothing to do in here
		}
		// ----------------------------------------------------------------------------
	...
	public boolean isDirectOutput() {
		System.out.println("NOAText_jsl: isDirectOutput - always returns false");
		return false;
	}
}
